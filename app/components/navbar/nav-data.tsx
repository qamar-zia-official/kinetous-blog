        ...
        children: (
            <Card>
                <div className="col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6 border-r border-zinc-100 dark:border-zinc-900 pr-6">
                    {/* 1. Revenue Systems */}
                    <a
                        href="https://kinetous.com/services/ecommerce-automation"
                    ...
                    >
                        <div className="flex items-center gap-2 font-medium text-zinc-900 dark:text-zinc-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                            ...
                            <span className="text-sm">
                                E-commerce Revenue Systems
                            </span>
                        </div>
                        <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                            Custom high-converting storefronts, performance
                            optimizations, and inventory or fulfillment
                            integrations.
                        </p>
                    </a>
                    ...
                    >
                        ...
                        <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                            24/7 AI-powered support assistants, automated lead
                            qualification, and contextual knowledge base syncs.
                        </p>
                    </a>
                    ...
                    >
                        ...
                        <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                            Operations command centers, custom workflows,
                            document extraction, and cross-system integrations.
                        </p>
                    </a>
                    ...
                    >
                        ...
                        <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                            Continuous performance monitoring, monthly
                            maintenance updates, security protocols, and
                            engineering advice.
                        </p>
                    </a>
                </div>
                ...
                <div className="col-span-4 flex flex-col justify-between p-4 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-zinc-900/60 dark:to-zinc-900/20 border border-blue-100/50 dark:border-zinc-800">
                    <div>
                        ...
                        <p className="text-[11px] text-zinc-600 dark:text-zinc-400 leading-relaxed">
                            Analyze your current architecture, performance, and
                            business messaging metrics using our AI scanner.
                        </p>
                    </div>
                    <Link
                        href="/audit"
                ...
                <div className="flex flex-col gap-3.5 border-r border-zinc-100 dark:border-zinc-900 pr-6">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-0.5">
                            ...
                            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-tight">
                                Headless WooCommerce core matched with AI social
                                automation.
                            </p>
                        </div>
                    </a>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-0.5">
                            ...
                            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-tight">
                                Lesson orchestration platform backed by
                                real-time canvas layers.
                            </p>
                        </div>
                    </a>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-0.5">
                            ...
                            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-tight">
                                Institutional CRM with live review dashboards
                                and tracking loops.
                            </p>
                        </div>
                    </a>
                ...
                <div className="flex flex-col gap-3.5 pl-2">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-0.5">
                            ...
                            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-tight">
                                Runs instant PageSpeed integrations alongside
                                Jina AI extraction filters.
                            </p>
                        </div>
                    </a>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-0.5">
                            ...
                            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-tight">
                                Advanced RAG engine configured with streaming
                                vectors for instant answer lookups.
                            </p>
                        </div>
                    </a>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-0.5">
                            ...
                            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-tight">
                                Multi-step intelligent funnel capturing
                                requirements and matching to Cal.com.
                            </p>
                        </div>
                    </a>
                </div>
